...
"""
 ...
 Run the example
    ...
    bin/spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.11:2.4.3 /home/rsi-psd-vm/pasta/proberequest_data_analyse/adaPNL.py localhost:9092 subscribe meu-topico-legal
"""
...
ACCESS_TOKEN = 'DP9KcWKQmxc1WJ8nU7CA'
...
if __name__ == "__main__":
    ...
    probes = probes.filter("MAC = '206432038951'").select(
        'SSID'
    ).distinct()
    ...
    #probes2 = probes.filter("MAC = '7cfadf099512'").select(
    #    'SSID'
    #).distinct()
